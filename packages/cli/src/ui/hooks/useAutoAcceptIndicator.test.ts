...
import { Config, ApprovalMode } from '@ai-masters-community/qwen-agents-code-core';
import type { Config as ActualConfigType } from '@ai-masters-community/qwen-agents-code-core';
