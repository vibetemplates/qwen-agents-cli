...
import type { MCPServerConfig } from '@ai-masters-community/qwen-agents-code-core';
import { MCPServerStatus, createTransport } from '@ai-masters-community/qwen-agents-code-core';
