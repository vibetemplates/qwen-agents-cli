...
export class GeminiChat {
  ...
  private pendingSystemInstruction?: string;
  ...
  setSystemInstruction(sysInstr: string) {
    this.pendingSystemInstruction = sysInstr;
    this.generationConfig.systemInstruction = sysInstr;
  }

  /**
   * Returns the current system instruction set for this chat session.
   */
  getSystemInstruction(): string | undefined {
    const sysInstr =
      this.pendingSystemInstruction ?? this.generationConfig.systemInstruction;
    return typeof sysInstr === 'string' ? sysInstr : undefined;
  }
